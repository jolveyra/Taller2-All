...
contract Calculator {
    ...
    modifier isOutOfRange(uint256 _a, uint256 _b) {
        require(_a <= 1000000000000 && _b <= 1000000000000, "Value out of range");
        _;
    }
     ...
     * @return _result Es un número uint256.
     */
    function division(uint _a, uint _b) external isOutOfRange(_a, _b) isBEqualOrLessThenA(_a, _b) pure returns(uint256 _result) {
        return _a / _b;        
    }
}
