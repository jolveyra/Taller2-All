...
contract Calculator {
    ...
    modifier isOutOfRange(uint256 _a, uint256 _b) {
        require(_a <= 1000000000000 && _b <= 1000000000000, "Out of range value");
        _;
    }
    ...
    modifier isBEqualOrLessThenA(uint256 _a, uint256 _b) {
        require(_b <= _a, "Subtrahend can't be greater than minuend");
        _;
    }
     ...
     */
    function addition(uint256 _a, uint256 _b) external isOutOfRange(_a, _b) pure returns(uint256 _result) {
        return _a + _b;
    }
     ...
     * @return _result Es un número uint256.
     */
    function subtraction(uint256 _a, uint256 _b) external isOutOfRange(_a, _b) pure returns(uint256 _result) {
        require(_b <= _a, "Subtrahend can't be greater than minuend");
        return _a - _b;        
    }
     ...
     * @return _result Es un número uint256.
     */
    function multiplication(uint256 _a, uint256 _b) external isOutOfRange(_a, _b) pure returns(uint256 _result) {
        return _a * _b;        
    }
     ...
     * @return _result Es un número uint256.
     */
    function division(uint _a, uint _b) external isOutOfRange(_a, _b) pure returns(uint256 _result) {
        require(_b != 0, "Dividend can't be zero");
        return _a / _b;        
    }
}
